...
class utils {
    ...
    static getDifficultyEmotes = async (sr) => {
        ...
        if(sr >= 8) emote = '<:diff80:870440266811723797>';
        else if(sr >= 7.9) emote = '<:diff79:870440239863328819>';
        else if(sr >= 7.5) emote = '<:diff75:870440211295899698>';
        else if(sr >= 7) emote = '<:diff70:870440185354137640>';
        else if(sr >= 6.5) emote = '<:diff65:870440155515867157>';
        else if(sr >= 6) emote = '<:diff60:870440128722649099>';
        else if(sr >= 5.5) emote = '<:diff55:870440099924561950>';
        else if(sr >= 5) emote = '<:diff50:870440070979661886>';
        else if(sr >= 4.5) emote = '<:diff45:870440045050474516>';
        else if(sr >= 4) emote = '<:diff40:870440012775325738>';
        else if(sr >= 3.5) emote = '<:diff35:870439983109001247>';
        else if(sr >= 3) emote = '<:diff30:870439954168283187>';
        else if(sr >= 2.5) emote = '<:diff25:870439918780952586>';
        else if(sr >= 2) emote = '<:diff20:870439874455543840>';
        else emote = '<:diff15:870439815592693801>';
